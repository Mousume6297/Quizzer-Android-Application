...
import static com.example.quizzerapplication.SportslvlActivity.listS;
...
public class QuestionSportsActivity extends AppCompatActivity {

    List<modelsports> allquestionlistS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allquestionlistS = listS;
        Collections.shuffle(allquestionlistS);
        modelsports = listS.get(index);
    ...
    private void setAllData() {
        ...
        card_question.setText(modelsports.getQuestionS());
        optionA.setText(modelsports.getoAS());
        optionB.setText(modelsports.getoBS());
        optionC.setText(modelsports.getoCS());
        optionD.setText(modelsports.getoDS());
    }
    ...
    private void Gamewon() {
        Intent intent = new Intent(QuestionSportsActivity.this, WonActivity.class);
    ...
    public void OptionAClick(View view) {
        ...
        if(modelsports.getoAS().equals(modelsports.getansS()))
        {
    ...
    public void OptionBClick(View view) {
        disablebtn();
        nextbtn.setClickable(true);
        if(modelsports.getoBS().equals(modelsports.getansS()))
        {
    ...
    public void OptionCClick(View view) {
        disablebtn();
        nextbtn.setClickable(true);
        if(modelsports.getoCS().equals(modelsports.getansS()))
        {
    ...
    public void OptionDClick(View view) {
        disablebtn();
        nextbtn.setClickable(true);
        if(modelsports.getoDS().equals(modelsports.getansS()))
        {
